...
You'll have the `binering-app.webhapp` in `workdir`. This is what you should distribute so that the Holochain Launcher can install it.

You will also have its subcomponent `binering-app.happ` in the same folder`.
