...
let CardComponent = class CardComponent extends LitElement {
    ...
    async doubleClick(e) {
        if (this.game.value.players[this.playerId].isComputer == true)
            return;
        // if (
        ...
        //   );
        // }
        await this.game.value.players[this.playerId].remove_card(e.target.getAttribute('card-data'));
    ...
    isDraggable() {
        if (this.game.value.players[this.playerId].isComputer)
            return false;
...
__decorate([
    state()
], CardComponent.prototype, "playerId", void 0);
__decorate([
    state()
], CardComponent.prototype, "deckId", void 0);
__decorate([
    state()
], CardComponent.prototype, "draggable", void 0);
