...
let MapComponent = class MapComponent extends LitElement {
    constructor() {
        super(...arguments);
        this.game = new StoreSubscriber(this, () => {
            return GameStore;
        });
        this.locations = [];
        this.show_board_game = true;
        this.iCANVAS_START_X_POS = 0;
        this.iCANVAS_START_Y_POS = 0;
        this.iCANVAS_HEIGHT = window.innerHeight; //790;
        this.iCANVAS_WIDTH = window.innerWidth; //1580;
    ...
    firstUpdated() {
        var _a;
        var canvas = (_a = this.shadowRoot) === null || _a === void 0 ? void 0 : _a.getElementById('map');
    ...
    render() {
      ...
      ${this.add_new_location(this.game.value.latitute, this.game.value.longtitude)}
    `;
    }
    add_new_location(lat, long) {
        //this.plotPosition();
        this.draw();
    }
    download() {
    ...
    drawLongitudeLines(ctx, iDEGREES_BETWEEN_GRID_LINES) {
        ctx.beginPath();
        ctx.lineWidth = 0.07;
        ctx.fillStyle = 'white';
    ...
    drawLandMass(ctx) {
        var landMass = this.getMapData(), iFirstScreenX = 0, iFirstScreenY = 0, shape, iLat, iLon, bFirst = false, iShapeCounter, iPointCouner;
...
__decorate([
    property({ type: Array })
], MapComponent.prototype, "coordination", null);
__decorate([
    property()
], MapComponent.prototype, "show_board_game", void 0);
